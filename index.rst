...
Welcome to the documentation for Citus 7.4! Citus horizontally scales PostgreSQL across commodity servers using sharding and replication. Its query engine parallelizes incoming SQL queries across these servers to enable real-time responses on large datasets.
...
.. image:: images/mt-shape.png
  :width: 0%
.. image:: images/rt-shape.png
  :width: 0%
