...
2. Install Citus on all machines:
  ...
  .. code-block:: bash
    ...
    sudo apt-get install -y postgresql-11-citus-rebalancer-8.2
...
2. Create a package tarball:
  ...
  .. code-block:: bash
    ...
    sudo apt-get clean
    # (the rebalancer package pulls in other necessary packages)
    sudo apt-get install -y --download-only postgresql-11-citus-rebalancer-8.2
...
2. Install Citus on all machines:
  ...
  .. code-block:: bash
    ...
    # (the rebalancer package pulls in other necessary packages)
    sudo yum install -y citus-rebalancer82_11
...
2. Create a package tarball:
  ...
  .. code-block:: bash
    ...
    # (the rebalancer package pulls in other necessary packages)
    sudo yum install --downloadonly --downloaddir=. citus-rebalancer82_11
