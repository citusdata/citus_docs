...
+----------------+----------------------+---------------------------------------------------------------------------+
| shardlength    |          bigint      | | For append partitioned tables, the size of the shard placement on the   |
|                |                      | | worker node in bytes.                                                   |
|                |                      | | For hash partitioned tables, zero.                                      |
+----------------+----------------------+---------------------------------------------------------------------------+
...
|                |                      | | can occur when an append or a modification (INSERT, UPDATE              |
|                |                      | | or DELETE ) operation fails for this placement. The query               |
...
+----------------+----------------------+---------------------------------------------------------------------------+
|   TO_DELETE    |            4         | | If CitusDB attempts to drop a shard placement in response to a          |
