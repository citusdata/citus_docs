...
Citus works with modern 64-bit Linux and most Unix based operating systems. Citus 5.0 offically supports PostgreSQL 9.5 and later versions. The extension will also work against PostgreSQL 9.4 but versions older than 9.4 are not supported.
